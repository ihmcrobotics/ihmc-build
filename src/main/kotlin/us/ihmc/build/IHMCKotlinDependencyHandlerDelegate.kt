...
abstract class IHMCKotlinDependencyHandlerDelegate : DependencyHandler
{
   ...
   {
      return delegate.addProvider(configurationName, dependencyNotation, configuration)
   }

   override fun <T : Any> addProvider(configurationName: String, dependencyNotation: Provider<T>)
   {
      return delegate.addProvider(configurationName, dependencyNotation)
   }
   ...
   {
      return delegate.addProviderConvertible(configurationName, dependencyNotation, configuration)
   }

   override fun <T : Any> addProviderConvertible(configurationName: String, dependencyNotation: ProviderConvertible<T>)
   {
      return delegate.addProviderConvertible(configurationName, dependencyNotation)
   }
   ...
   {
      return delegate.registerTransform(actionType, registrationAction)
   }
